function I=make_icon_memex_graph_directed(subA, train, ids, other)
...
for i = 1:length(ids)
  ...
  other.shapestring{i} = sprintf('shape=circle', ...
                                 ids(i));
...
if nargout == 0
  make_memex_graph_directed(subA, other);
else
  I = make_memex_graph_directed(subA, other);
end
