...
for iterations = 1:10
  ...
  [m, mining_queue] = learn_with_positives(m, mining_queue, bg, ...
                                           mining_params);
...
function [m,mining_queue] = learn_with_positives(m,  mining_queue, bg, ...
                                                 mining_params)
